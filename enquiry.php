                            ...
                            <div class="header-content">
                                <div class="header-content-inner">
                                    ...
                                    <div class="ui breadcrumb">
                                        ...
                                        <div class="active section">Book Enquiry</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12 contact-form">
                                <div class="row">
										<?php
											if(isset($_GET["id"]))
											{
												$row = mysqli_fetch_array(mysqli_query($conn,"select * from tbl_package where id = '".$_GET["id"]."' and status = 1"));
										?>
											<div class="col-sm-12">
												<div class="form-group">
													<label>Enquiry For</label>
													<input type="text" class="form-control" id="enquiryfor" name="enquiryfor" value="<?=$row["name"]; ?>" readonly>
												</div>
											</div>
										...
										?>
											<div class="col-sm-12">
												<div class="form-group">
													<label>Enquiry For </label>
													<input type="text" class="form-control" id="enquiryfor" name="enquiryfor" placeholder="Enquiry For" >
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="col-sm-4">
													<div class="form-group">
														...
														<input type="text" placeholder="Tarvel Date" class="form-control" id="datepicker1"/>
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
