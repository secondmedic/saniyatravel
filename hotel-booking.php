                            ...
                            <div class="header-content">
                                <div class="header-content-inner">
                                    ...
                                    <div class="ui breadcrumb">
                                        ...
                                        <div class="active section">Hotel Booking</div>
                                    </div>
                                </div>
                            </div>
                        </div>
											...
											<div class="col-md-12">
												<div class="col-sm-12">
													<div class="form-group">
														...
														<input type="text" placeholder="Hotel Destination" class="form-control" />
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group">
														<label>Check In Date</label>
														<input type="text" placeholder="Check In Date" class="form-control" id="datepicker1"/>
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group">
														<label>Check Out Date</label>
														<input type="text" placeholder="Check Out Date" class="form-control" id="datepicker2"/>
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
